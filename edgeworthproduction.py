...
# initial parameters
ALPHA = 0.1   # capital share in agriculture
BETA = 0.9   # capital share in manufacturing
KBAR = 891.7  # Total capital supply
LBAR = 52.5  # Total labor supply
...
def ppf(LA,Kbar=KBAR, Lbar=LBAR,alpha=ALPHA,beta=BETA):
    ...
    ax.set_ylim(0, Kbar)
    ax.plot(Qa, Qm,'k-')
    ax.set_xlabel(r'$Q (PC)$',fontsize=18)
    ax.set_ylabel(r'$Q (COPPER)$',fontsize=18)
    plt.show()
